  ...
  <body>
  	...
  	<div id="userinfo">
  		<form action="#" method="post">
  			...
  			<div class="info">博客名称：  <input type="text" id="blogName" maxlength="10" value="${INFO.userInfo.blogName}" class="inf"/></div>
  			<div class="info">博客签名：  <input type="text" id="blogSign" maxlength="10" value="${INFO.userInfo.blogSign}" class="inf"/></div>
